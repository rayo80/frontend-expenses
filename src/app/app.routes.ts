...
export const appRoutes: Route[] = [
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'purchases'},
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'purchases', loadChildren: () => import('app/modules/apps/purchases/purchases.module').then(m => m.PurchasesModule)},
